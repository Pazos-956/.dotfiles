...
# Export PATH$
export PATH=~/.local/bin:/snap/bin:/usr/sandbox/:/usr/local/bin:/usr/bin:/bin:/opt/Discord:/usr/local/games:/usr/games:/usr/share/games:/usr/local/sbin:/usr/sbin:/sbin:/home/abel/.config/bin:/home/abel/miniconda3/bin:/home/abel/go/bin:$PATH
...
# custom alias
#-----------------------------------------------
# Esto hace que sudo pueda usar los alias
# Solo se comprueba la primera palabra para ver los alias, por eso de normal no los encuentra
alias sudo='sudo '
...
alias tree='lsd --tree'
# apt update & parrot-upgrade
alias update='sudo apt update && sudo parrot-upgrade'
...
source /home/abel/powerlevel10k/powerlevel10k.zsh-theme
